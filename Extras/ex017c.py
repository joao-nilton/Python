...
print ("  {:^150}  ".format('\033[1;31m"HIPOTENUSA."\033[m'))
print('\033[1;36m=\033[m' * 312)  
print (' ')
...
print('=' * 40)
print('\033[1;31mEste é um medidor da hipotenusa a partir da medida dos catetos.\033[m') 
print('=' * 40)

co = float(input('\n\033[1;33mDigite o comprimento do cateto oposto em cm: \033[m'))
ca = float(input('\033[1;33mDigite o comprimento do cateto adjacente em cm: \033[m'))
# hip = (co**2 + ca**2)** (1/2) 
 #hip = math.hypot(co, ca)
hip = hypot(co, ca)

print('\n\033[1;32mO valor da hipotenusa  é {}\033[m'.format(hip))
print(' ')
