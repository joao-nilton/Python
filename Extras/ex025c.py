...
print ("  {:^150}  ".format('\033[1;31m"PROGRAMA PARA ANALISAR NOME."\033[m'))
print('\033[1;36m=\033[m' * 312)  
print (' ')
...
nome = str(input( '\033[1;36;41mDigite o seu nome completo: \033[m')).strip()
print (' ')
print('\033[1;33mSeu nome tem silva? {}\033[m'.format('SILVA' in nome.upper())) # in é operador e não método
print (' ')
print('=' * 40)
