...
a1 = input('\033[1;35mDigite o nome do aluno 1: \033[m')
a2 = input('\033[1;35mDigite o nome do aluno 2: \033[m')
a3 = input('\033[1;35mDigite o nome do aluno 3: \033[m')
a4 = input('\033[1;35mDigite o nome do aluno 4: \033[m')

lista = [a1, a2, a3, a4 ]

sorteio = choice(lista)
print (' ')
print('\033[1;34mO (A) aluno(a) sorteado foi\033[m \033[1;35m{}\033[m: '.format(sorteio))
