...
"""#############################################################################################################"""
q1 = int(input('Quantas atividades foram propostas de 2 a 6: '))
q2 = int(input('Qual é o peso para as provas de 1 a 4: '))
q3 = int(input('Qual é o peso para trabalhos, apresentações, seminários de 1 a 4: '))
