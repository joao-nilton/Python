...
print (' ')
print('=' * 312)
print ("  {:^150}  ".format('\033[1;31m"CÁLCULO DA QUANTIDADE DE TINTA"\033[m'))
print('=' * 312)  
print (' ')
...
print('\033[1;33mCálculo de quantidade de tinta necessária\033[m') 
print('\033[1;31m=\033[m' * 40)
print("\n" * 1)
...
print('\nA área a ser pintada corresponde a {} metro(s)quadrado(s).'.format(r)) 
