...
print (' ')
print('=' * 312)
print ("  {:^150}  ".format('\033[1;31m"CONVERSOR REAIS / DOLAR"\033[m'))
print('=' * 312)  
print (' ')
...
r = float(input('\033[1;32mDigite o valor que você quer converter de Reais para Dolares: \033[m'))
d = float(input('\033[1;33mDigite  o valor do dolar hoje: \033[m'))
c = r / d
print('\033[1;34m{} Real(s) equivalem a {:.2f} Dolar(s)\033[m'.format(r,c))
print('=' * 40)
